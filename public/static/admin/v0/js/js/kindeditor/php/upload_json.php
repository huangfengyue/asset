...
require_once $_SERVER['DOCUMENT_ROOT'].'/'.CATALOG.'/vendor/autoload.php';
const accessKeyId = 'LTAITRzMn7xTuEO1';
const accessKeySecret = '3oTCkT9BSdWs1akmuMLMwMA6H6A8ME';
...
//	$file_url = $save_url . $new_file_name;
	...
	//$object = $file_name.time().uniqid().'.'.$file_ext;
	$object = "upload/".time().uniqid().'.'.$file_ext;
	$filePath =$tmp_name; //文件路径
	$res = uploads($object, $filePath);
	$file_url = $res['url'];
...
function uploads($object, $filePath){
