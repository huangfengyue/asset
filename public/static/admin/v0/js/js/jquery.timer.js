...
//
    $('.timeRange').click(function(){
        ...
        var hourOpts1 = '';
        var hourOpts2 = '';
        for (i=0;i<24;i++) hourOpts1 += '<option>'+i+'</option>';
        for (i=0;i<24;i++) hourOpts2 += '<option>'+i+'</option>';
        var minuteOpts = '<option>00</option><option>10</option><option>20</option><option>30</option><option>40</option><option>50</option>';

        var html = $('<div id="timeRange_div"><select id="timeRange_a">'+hourOpts1+
        '</select>:<select id="timeRange_b">'+minuteOpts+
        '</select>-<select id="timeRange_c">'+hourOpts2+
