    ...
    layui.use(["layer"],function () {
        ...
        $("#btn-agree").click(function () {
            ...
            layer.confirm("确定通过该项审核吗？",{btn:["确定","取消"]},function () {
                $.post("/fushen/asset/"+apply_id+"/update",{"remark":remark},function (re) {
                    if(re.status == 200){
                        window.location.href = "/fushen/asset";
                    }else{
                        layer.msg(re.msg);
                    }
                });
        ...
        $("#btn-ignore").click(function () {
            ...
            layer.confirm("确定拒绝该项审核吗？",{btn:["确定","取消"]},function () {
                $.post("/fushen/asset/"+apply_id+"/update",{"result":"ignore","remark":remark},function (re) {
                    if(re.status == 200){
                        window.location.href = "/fushen/asset";
                    }else{
                        layer.msg(re.msg);
        ...
        $("#btn-back").click(function () {
            ...
            layer.confirm("确定退回该项审核吗？",{btn:["确定","取消"]},function () {
                $.post("/fushen/asset/"+apply_id+"/update",{"result":"back","remark":remark},function (re) {
                    if(re.status == 200){
                        window.location.href = "/fushen/asset";
                    }else{
                        layer.msg(re.msg);
