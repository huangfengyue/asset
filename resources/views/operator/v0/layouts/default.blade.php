...
<head>
    ...
    @yield("head")
    <link href="{{asset('static/operator/v0/css/style.css')}}" rel="stylesheet">
    ...
    <script src="{{asset('static/operator/v0/js/inspinia.js')}}"></script>
    <script src="{{asset('static/operator/v0/js/common.js')}}"></script>
</head>
<body>
<div id="wrapper">
    @include('operator.v0.layouts.sidebar')
