...
<div class="content">
    ...
    <h2>第三条、服务费 </h2>
    <p>在本协议中，“服务费”是指因甲方为乙方提供业务咨询、评估、推荐出借人、还款 提醒、账户管理、还款特殊情况沟通等系列相关服务为乙方提供信用审核等服务而由乙方支付给甲方的报酬。对于甲方向乙方提供的系列服务，乙方同意在获得《借款协议》约定的借款资金的当日向甲方支付服务费人民币￥<span class="xhx">{{$applyInfo->apply_service_amt}}</span>元整（大写：<span class="xhx">
           {{$applyInfo->service}}
    ...
    <p class="jc">提前还款说明：</p>
    <p>1、30期{{$applyInfo->loan_category}}产品：8期后可以提前还款，提前还款都需收取一期借款服务费作为提前还款服务费。</p>
