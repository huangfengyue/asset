...
<div class="content">
    ...
    <table border="1" cellpadding="0"  cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <td class="al_left">￥：{{$applyInfo->apply_amt_all}}</td>
    ...
    @elseif($applyInfo["loan_category"]=="商户贷")
        <p>4.1 可提前还款，乙方提前还款的，需一次性支付剩余贷款本金+当期应还本息及借款合同金额3%的还款违约金进行贷款提前还款结清。 </p>@endif
    <h2>五、违约责任</h2>
    <p>5.1 若乙方在还款期限之前未按照合同约定的收支账户存入还款金额或存入金额不 足的，即构成违约，并向甲方、丙方承担以下违约责任： </p>
    <p>5.1.1 甲方自应还款日起每日按借款合同金额的  @if($applyInfo["loan_category"]=="佰事贷")0.1%@elseif($applyInfo["loan_category"]=="商户贷")0.3% @endif收取罚息。 </p>
