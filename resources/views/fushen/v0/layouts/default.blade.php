...
<head>
    ...
    @yield("head")
    <link href="{{asset('static/fushen/v0/css/style.css')}}" rel="stylesheet">
    ...
    <script src="{{asset('static/fushen/v0/js/inspinia.js')}}"></script>
    <script src="{{asset('static/fushen/v0/js/common.js')}}"></script>
</head>
<body>
<div id="wrapper">
    @include('fushen.v0.layouts.sidebar')
