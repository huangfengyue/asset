<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li @if(preg_match('/^fushen\/(asset|repay|asset\/\S+)$/',$currentRoute)) class="active" @endif>
                <a href="javascript:;"><i class="fa fa-cog"></i> <span class="nav-label">审件模块</span> <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">
                    <li @if(preg_match('/^fushen\/asset$/',$currentRoute)) class="active" @endif><a href="/fushen/asset">审件列表</a></li>
                    <li @if(preg_match('/^fushen\/asset\/check2/',$currentRoute)) class="active" @endif><a href="/fushen/asset/check2">面签列表</a></li>
                    <li @if(preg_match('/^fushen\/asset\/repay/',$currentRoute)) class="active" @endif><a href="/fushen/asset/repay">还款列表</a></li>
                    <li @if(preg_match('/^fushen\/repay$/',$currentRoute)) class="active" @endif><a href="/fushen/repay">还款跟踪</a></li>
                </ul>
            </li>
