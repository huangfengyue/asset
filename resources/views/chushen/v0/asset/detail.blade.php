    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-2">
            <div class="title-action">
                <a href="/chushen/asset/{{$applyInfo->apply_id}}/jlx" class="btn btn-info">聚信立报告</a>
                <a href="/chushen/asset/{{$applyInfo->apply_id}}/cert" class="btn btn-info">证件资料压缩包</a>
                <a href="/chushen/asset/{{$applyInfo->apply_id}}/ck2-info" class="btn btn-info">借款合同压缩包</a>
