...
@section("head")
    <script src="{{asset('static/chushen/v0/js/asset/updateApply.js')}}"></script>
@endsection
@section("content")
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-2">
            <div class="title-action">
                <a href="/chushen/asset/{{$applyInfo->apply_id}}/face_detail" class="btn btn-info">面审录入查询</a>
            </div>
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="apply_amt_final" lay-verify="apply_amt_final" value="">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
