...
<head>
    ...
    @yield("head")
    <link href="{{asset('static/assetor/v0/css/style.css')}}" rel="stylesheet">
    ...
    <script src="{{asset('static/assetor/v0/js/inspinia.js')}}"></script>
    <script src="{{asset('static/assetor/v0/js/common.js')}}"></script>
</head>
<body>
<div id="wrapper">
    @include('assetor.v0.layouts.sidebar')
