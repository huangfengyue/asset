...
@section("title","资产管理")
@section("head")
    <script type="text/javascript" src="{{asset('static/assetor/v0/js/asset/listByCheck2.js')}}"></script>
@endsection
@section("content")
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="{{url('assetor/asset/ck2_excel')}}" class="btn btn-info">导出excel表格</a>
