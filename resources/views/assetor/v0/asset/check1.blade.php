                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="asset_ck1_remark" placeholder="请填写您审核的意见或建议">{{$applyInfo->asset_ck1_remark}}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <a class="btn btn-white" href="/assetor/asset">返回</a>
