    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="/assetor/asset/check2">二审列表</a>
                </li>
                <li class="active">
                    <strong>请审核</strong>
                </li>
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="asset_ck2_remark" placeholder="请填写您审核的意见或建议">{{$applyInfo->asset_ck2_remark}}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <a class="btn btn-white" href="/assetor/asset/check2">返回</a>
