...
@section("title","资产管理")
@section("head")
    <script type="text/javascript" src="{{asset('static/zhongshen/v0/js/asset/enlist.js')}}"></script>
@endsection
@section("content")
                        ...
                        <div class="ibox-tools">
                                <div>
                                    ...
                                    <strong><font style="font-size: 15px">状态</font></strong>:&nbsp;&nbsp;&nbsp;<select name="status" id="status">
                                        ...
                                        <option value="8">等待生成</option>
                                        <option value="9">等待上传</option>
                                        <option value="10">等待放款</option>
                                        <option value="11">拒绝面签</option>
                                    </select>
