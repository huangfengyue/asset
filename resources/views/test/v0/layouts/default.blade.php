...
<head>
    ...
    @yield("head")
    <link href="{{asset('static/test/v0/css/style.css')}}" rel="stylesheet">
    ...
    <script src="{{asset('static/test/v0/js/inspinia.js')}}"></script>
    <script src="{{asset('static/test/v0/js/common.js')}}"></script>
</head>
<body>
<div id="wrapper">
    @include('test.v0.layouts.sidebar')
