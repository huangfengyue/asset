        ...
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element"> <span>
                  <img alt="image" class="img-circle" src="/static/test/v0/img/profile_small.jpg">
                   </span>
                    <a data-toggle="dropdown" class="dropdown-toggle" href="www.baidu.com">
                  <span class="clear"> <span class="block m-t-xs"> haha <strong class="font-bold"></strong>
                   </span> <span class="text-muted text-xs block">haha <b class="caret"></b></span> </span> </a>
