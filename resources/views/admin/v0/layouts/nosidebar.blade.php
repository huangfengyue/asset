...
<head>
    ...
    @yield("head")
    <link href="{{asset('static/admin/v0/css/style.css')}}" rel="stylesheet">
    ...
    <script src="{{asset('static/admin/v0/js/inspinia.js')}}"></script>
    <script src="{{asset('static/admin/v0/js/common.js')}}"></script>
</head>
<body>
@yield('content')
</body>
