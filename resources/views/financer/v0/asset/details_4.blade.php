...
<div class="content">
    ...
    <table class="tet" border="0" cellpadding="0"  cellspacing="0" width="100%">
        ...
        <tr>
            <td class="w">借款合同金额：¥
                @if($applyInfo["loan_category"]=="佰事贷"){{$applyInfo->apply_amt_all}}@elseif($applyInfo["loan_category"]=="商户贷"||$applyInfo["loan_category"]=="街边贷"){{$applyInfo->apply_amt_final}}@endif</td>
    ...
    <p>&nbsp;&nbsp;&nbsp;&nbsp; @if($applyInfo["loan_category"]=="佰事贷")借款成功当日扣除第一期应还金额，为了延续您良好的信用记录，请在每周还款日前一天检查确认当周应还款项已经存入专用账户，谢谢配合。提前全额还款：如果您决定提前结清借款，请通知当地分公司按要求办理提前还款手续，提前结清应退服务费在一次性全额还款金额中抵扣。
@elseif($applyInfo["loan_category"]=="街边贷")提前全额还款：如果您决定提前结清借款，需还满15期且按要求办理提前还款手续，并需一次性支付剩余贷款本金+当期应还本息；如未还满15期则另需支付借款合同金额3%的还款违约金进行贷款提前还款结清。@endif
</p>
