...
<div class="content">
    ...
    <table class="tet" border="0" cellpadding="0"  cellspacing="0" width="100%">
        ...
        <tr>
            <td class="w">借款合同金额：¥
                @if($applyInfo["loan_category"]=="佰事贷"){{$applyInfo->apply_amt_all}}@elseif($applyInfo["loan_category"]=="街边贷"){{$applyInfo->apply_amt_final}}@endif</td>
    ...
    <table class="tex" border="1" cellpadding="0"  cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <td>{{$v["apply_week_service_amt"]}}</td>
            <td>{{$v["repay_late_days"]}}</td>
            <td>{{$v["repay_late_amt"]}}</td>
            <td>{{$v["now_amt_all"]}}</td>
            <td>{{$v["real_amt_all"]}}</td>
            <td>{{$v["status_name"]}}</td>
        </tr>
        @endforeach
