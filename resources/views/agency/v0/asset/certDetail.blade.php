...
@section("title","证书详情")
@section("head")
<script src="{{asset('static/agency/v0/js/asset/certDetail.js')}}"></script>
@endsection
@section("content")
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="/agency/asset/{{$applyInfo->apply_id}}">申请单详情</a>
                </li>
                <li class="active">
                    <strong>证件详情</strong>
                </li>
        ...
        <div class="col-lg-2">
            <div class="title-action">
                <a href="/agency/asset/{{$applyInfo->apply_id}}" class="btn btn-info">基本信息</a>
            </div>
        </div>
    </div>
