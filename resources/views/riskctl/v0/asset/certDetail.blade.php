...
@section("title","证书详情")
@section("head")
<script src="{{asset('static/riskctl/v0/js/asset/certDetail.js')}}"></script>
@endsection
@section("content")
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="/riskctl/asset/{{$applyInfo->apply_id}}">申请单详情</a>
                </li>
                <li class="active">
                    <strong>证件详情</strong>
                </li>
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <a class="btn btn-white" href="/riskctl/asset">返回</a>
                                </div>
                            </div>
                        </form>
                    </div>
