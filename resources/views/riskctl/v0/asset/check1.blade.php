...
@section("head")
    <script src="{{asset('static/riskctl/v0/js/asset/check1.js')}}"></script>
@endsection
@section("content")
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-2">
            <div class="title-action">
                <a href="/riskctl/asset/{{$applyInfo->apply_id}}/cert" class="btn btn-info">证件信息</a>
            </div>
        </div>
    </div>
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="riskctl_ck1_remark" placeholder="请填写您审核的意见或建议">{{$applyInfo->riskctl_ck1_remark}}</textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
