...
<head>
    ...
    @yield("head")
    <link href="{{asset('static/riskctl/v0/css/style.css')}}" rel="stylesheet">
    ...
    <script src="{{asset('static/riskctl/v0/js/inspinia.js')}}"></script>
    <script src="{{asset('static/riskctl/v0/js/common.js')}}"></script>
</head>
<body>
<div id="wrapper">
    @include('riskctl.v0.layouts.sidebar')
